(() => {
  ...
  const root = document.documentElement;
    ...
    const serviceContent = {"en": {"definition": {"kicker": "01 · Product Definition Sprint", "title": "Turn ambiguity into a product direction the team can act on.", "description": "We connect the business problem, user workflows and technical constraints before the build creates avoidable product or architecture debt.", "deliverables": ["Problem framing", "Priority users", "Core workflows", "Prototype", "Scope", "Architecture outline"], "icon": "travel_explore", "best": "Best when the problem is real, but the product direction is still unclear.", "note": "Suitable before an MVP, redesign, major feature or technical commitment."}, "foundation": {"kicker": "02 · Product Foundation", "title": "Design and build a serious foundation across product and engineering.", "description": "We shape the experience and establish the frontend, backend, data and cloud foundations needed for a reliable first product version.", "deliverables": ["UX/UI", "Design system", "Frontend", "Backend services", "APIs & data", "Cloud setup"], "icon": "foundation", "best": "Best when the concept is validated and needs to become dependable software.", "note": "Suitable for funded startups, product teams and new internal platforms."}, "rescue": {"kicker": "03 · Product Rescue & Modernisation", "title": "Untangle an existing product without ignoring its real constraints.", "description": "We assess confusing workflows, inconsistent UI, fragile architecture and delivery gaps, then create a realistic improvement path.", "deliverables": ["Product audit", "UX assessment", "Technical assessment", "Priority map", "Modernisation plan", "Target foundations"], "icon": "sync_alt", "best": "Best when the current product works, but is difficult to use, change or scale.", "note": "Suitable for legacy systems, growing SaaS products and operational tools."}, "fractional": {"kicker": "04 · Fractional Product & Technical Leadership", "title": "Add senior product and engineering direction without two full-time hires.", "description": "We work alongside an existing team to improve priorities, UX quality, architectural decisions, platform foundations and delivery alignment.", "deliverables": ["Roadmap support", "Backlog quality", "Design direction", "Architecture", "Platform guidance", "Team enablement"], "icon": "supervisor_account", "best": "Best when a capable team needs stronger cross-functional ownership.", "note": "Suitable for ongoing monthly collaboration with founders or product teams."}}, "es": {"definition": {"kicker": "01 · Sprint de definición de producto", "title": "Convierte la ambigüedad en una dirección de producto sobre la que el equipo pueda actuar.", "description": "Conectamos el problema de negocio, los flujos de usuario y las restricciones técnicas antes de que la construcción genere deuda evitable de producto o arquitectura.", "deliverables": ["Definición del problema", "Usuarios prioritarios", "Flujos principales", "Prototipo", "Alcance", "Esquema de arquitectura"], "icon": "travel_explore", "best": "Ideal cuando el problema es real, pero la dirección de producto todavía no está clara.", "note": "Adecuado antes de un MVP, rediseño, funcionalidad importante o compromiso técnico."}, "foundation": {"kicker": "02 · Base de producto", "title": "Diseña y construye una base sólida de producto e ingeniería.", "description": "Damos forma a la experiencia y establecemos las bases de frontend, backend, datos y cloud necesarias para una primera versión fiable.", "deliverables": ["UX/UI", "Sistema de diseño", "Frontend", "Servicios backend", "APIs y datos", "Configuración cloud"], "icon": "foundation", "best": "Ideal cuando el concepto está validado y necesita convertirse en software fiable.", "note": "Adecuado para startups financiadas, equipos de producto y nuevas plataformas internas."}, "rescue": {"kicker": "03 · Rescate y modernización de producto", "title": "Desbloquea un producto existente sin ignorar sus restricciones reales.", "description": "Evaluamos flujos confusos, UI inconsistente, arquitectura frágil y problemas de entrega para crear una ruta de mejora realista.", "deliverables": ["Auditoría de producto", "Evaluación UX", "Evaluación técnica", "Mapa de prioridades", "Plan de modernización", "Bases objetivo"], "icon": "sync_alt", "best": "Ideal cuando el producto funciona, pero es difícil de usar, cambiar o escalar.", "note": "Adecuado para sistemas legacy, SaaS en crecimiento y herramientas operativas."}, "fractional": {"kicker": "04 · Liderazgo fraccional de producto y tecnología", "title": "Añade dirección sénior de producto e ingeniería sin realizar dos contrataciones completas.", "description": "Trabajamos junto al equipo para mejorar prioridades, calidad UX, decisiones de arquitectura, bases de plataforma y alineación de entrega.", "deliverables": ["Soporte de roadmap", "Calidad del backlog", "Dirección de diseño", "Arquitectura", "Guía de plataforma", "Desarrollo del equipo"], "icon": "supervisor_account", "best": "Ideal cuando un equipo competente necesita una responsabilidad transversal más sólida.", "note": "Adecuado para una colaboración mensual con founders o equipos de producto."}}, "pt": {"definition": {"kicker": "01 · Sprint de definição de produto", "title": "Transforme a ambiguidade numa direção de produto sobre a qual a equipa pode agir.", "description": "Ligamos o problema de negócio, os fluxos dos utilizadores e as restrições técnicas antes que a construção crie dívida evitável de produto ou arquitetura.", "deliverables": ["Definição do problema", "Utilizadores prioritários", "Fluxos principais", "Protótipo", "Âmbito", "Esboço de arquitetura"], "icon": "travel_explore", "best": "Ideal quando o problema é real, mas a direção de produto ainda não está clara.", "note": "Adequado antes de um MVP, redesign, funcionalidade importante ou compromisso técnico."}, "foundation": {"kicker": "02 · Base de produto", "title": "Desenhe e construa uma base sólida de produto e engenharia.", "description": "Damos forma à experiência e estabelecemos as bases de frontend, backend, dados e cloud necessárias para uma primeira versão fiável.", "deliverables": ["UX/UI", "Design system", "Frontend", "Serviços backend", "APIs e dados", "Configuração cloud"], "icon": "foundation", "best": "Ideal quando o conceito está validado e precisa de se tornar software fiável.", "note": "Adequado para startups financiadas, equipas de produto e novas plataformas internas."}, "rescue": {"kicker": "03 · Resgate e modernização de produto", "title": "Desbloqueie um produto existente sem ignorar as suas restrições reais.", "description": "Avaliamos fluxos confusos, UI inconsistente, arquitetura frágil e falhas de entrega para criar um caminho de melhoria realista.", "deliverables": ["Auditoria de produto", "Avaliação UX", "Avaliação técnica", "Mapa de prioridades", "Plano de modernização", "Bases objetivo"], "icon": "sync_alt", "best": "Ideal quando o produto funciona, mas é difícil de utilizar, alterar ou escalar.", "note": "Adequado para sistemas legacy, produtos SaaS em crescimento e ferramentas operacionais."}, "fractional": {"kicker": "04 · Liderança fracionada de produto e tecnologia", "title": "Adicione direção sénior de produto e engenharia sem duas contratações a tempo inteiro.", "description": "Trabalhamos com a equipa para melhorar prioridades, qualidade UX, decisões de arquitetura, bases de plataforma e alinhamento da entrega.", "deliverables": ["Apoio ao roadmap", "Qualidade do backlog", "Direção de design", "Arquitetura", "Orientação de plataforma", "Desenvolvimento da equipa"], "icon": "supervisor_account", "best": "Ideal quando uma equipa competente precisa de uma responsabilidade transversal mais forte.", "note": "Adequado para colaboração mensal contínua com founders ou equipas de produto."}}};
